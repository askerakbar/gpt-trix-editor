<x-dynamic-component :component="$getFieldWrapperView()" :id="$getId()" :label="$getLabel()" :label-sr-only="$isLabelHidden()" :helper-text="$getHelperText()" :hint="$getHint()" :hint-action="$getHintAction()" :hint-color="$getHintColor()" :hint-icon="$getHintIcon()" :required="$isRequired()" :state-path="$getStatePath()">
    <div x-data="richEditorFormComponent({
            ...
            <div class="flex justify-between space-x-4 rtl:space-x-reverse overflow-x-auto items-stretch overflow-y-hidden">
                <div class="flex items-stretch space-x-4 outline-none rtl:space-x-reverse">
                    ...
                    <div data-trix-button-group="text-tools" class="flex items-stretch space-x-1 rtl:space-x-reverse">
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="bold" data-trix-key="b" title="{{ __('forms::components.rich_editor.toolbar_buttons.bold') }}" tabindex="-1" title="{{ __('forms::components.rich_editor.toolbar_buttons.bold') }}">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="italic" data-trix-key="i" title="{{ __('forms::components.rich_editor.toolbar_buttons.italic') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="strike" title="{{ __('forms::components.rich_editor.toolbar_buttons.strike') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="href" data-trix-action="link" data-trix-key="k" title="{{ __('forms::components.rich_editor.toolbar_buttons.link') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                    ...
                    <div data-trix-button-group="heading-tools" class="flex items-stretch space-x-1 rtl:space-x-reverse">
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="heading1" title="{{ __('forms::components.rich_editor.toolbar_buttons.h1') }}" tabindex="-1">
                            {{ __('forms::components.rich_editor.toolbar_buttons.h1') }}
                        </x-forms::rich-editor.toolbar-button>
                        @endif

                        @if ($hasToolbarButton('h2'))
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="heading" title="{{ __('forms::components.rich_editor.toolbar_buttons.h2') }}" tabindex="-1">
                            {{ __('forms::components.rich_editor.toolbar_buttons.h2') }}
                        </x-forms::rich-editor.toolbar-button>
                        @endif

                        @if ($hasToolbarButton('h3'))
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="subHeading" title="{{ __('forms::components.rich_editor.toolbar_buttons.h3') }}" tabindex="-1">
                    ...
                    <div data-trix-button-group="block-tools" class="flex items-stretch space-x-1 rtl:space-x-reverse">
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="quote" title="{{ __('forms::components.rich_editor.toolbar_buttons.blockquote') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="code" title="{{ __('forms::components.rich_editor.toolbar_buttons.code_block') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="bullet" title="{{ __('forms::components.rich_editor.toolbar_buttons.bullet_list') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                        ...
                        <x-forms::rich-editor.toolbar-button data-trix-attribute="number" title="{{ __('forms::components.rich_editor.toolbar_buttons.ordered_list') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                    ...
                    <div data-trix-button-group="file-tools" class="flex items-stretch space-x-1 rtl:space-x-reverse">
                        <x-forms::rich-editor.toolbar-button data-trix-action="attachFiles" title="{{ __('forms::components.rich_editor.toolbar_buttons.attach_files') }}" tabindex="-1">
                            <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                ...
                <div data-trix-button-group="history-tools" class="flex items-center space-x-1 rtl:space-x-reverse">
                    ...
                    <x-forms::rich-editor.toolbar-button data-trix-action="undo" data-trix-key="z" title="{{ __('forms::components.rich_editor.toolbar_buttons.undo') }}" tabindex="-1">
                        <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
                    ...
                    <x-forms::rich-editor.toolbar-button data-trix-action="redo" data-trix-key="shift+z" title="{{ __('forms::components.rich_editor.toolbar_buttons.redo') }}" tabindex="-1">
                        <svg @class([ 'h-4' , 'dark:fill-current'=> config('forms.dark_mode'),
            ...
            <div data-trix-dialogs class="trix-dialogs" x-cloak>
                <div data-trix-dialog="href" data-trix-dialog-attribute="href" class="trix-dialog trix-dialog--link">
                    <div class="trix-dialog__link-fields">
                        <input name="href" placeholder="{{ __('forms::components.rich_editor.dialogs.link.placeholder') }}" aria-label="{{ __('forms::components.rich_editor.dialogs.link.label') }}" required data-trix-input disabled type="url" class="trix-input trix-input--dialog">

                        <div class="trix-button-group">
                            <input value="{{ __('forms::components.rich_editor.dialogs.link.buttons.link') }}" data-trix-method="setAttribute" type="button" class="trix-button trix-button--dialog">

                            <input value="{{ __('forms::components.rich_editor.dialogs.link.buttons.unlink') }}" data-trix-method="removeAttribute" type="button" class="trix-button trix-button--dialog">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <trix-editor wire:ignore {!! $isAutofocused() ? 'autofocus' : null !!} id="{{ $getId() }}" input="trix-value-{{ $getId() }}" placeholder="{{ $getPlaceholder() }}" toolbar="trix-toolbar-{{ $getId() }}" x-ref="trix" dusk="filament.forms.{{ $getStatePath() }}" {{ $getExtraInputAttributeBag()->class([
